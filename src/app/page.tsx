export default function ClientPage() {
	...
	return (
		<div className="h-svh flex flex-col bg-background text-foreground">
			{/* Global top bar */}
			<header className="h-12 shrink-0 border-b border-white/10 bg-gradient-to-r from-[#330d38] to-[#230525] text-white">
				<div className="h-full px-3 sm:px-4 flex items-center gap-2">
					{/* Left cluster */}
					<button className="md:hidden p-1.5 rounded hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-white/20" title="Toggle sidebar">
					...
					<div className="hidden sm:flex items-center gap-1 rounded px-2 py-1 bg-white/10">
						...
						<svg viewBox="0 0 24 24" className="size-4 text-white/70" fill="currentColor" aria-hidden>
					...
					<div className="flex-1 flex justify-center">
						<label className="relative w-full max-w-xl">
							...
							/>
							<svg viewBox="0 0 24 24" className="size-4 absolute left-2 top-1/2 -translate-y-1/2 text-white/70" fill="none" aria-hidden>
					...
					<div className="flex items-center gap-1.5">
						<button className="p-1.5 rounded hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-white/20" title="Help">
							<svg viewBox="0 0 24 24" className="size-5" fill="none" aria-hidden>
								<circle cx="12" cy="12" r="9" stroke="currentColor" strokeWidth="2" />
								<path d="M12 16v-1a3 3 0 1 1 3-3" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
								<circle cx="12" cy="18" r="1" fill="currentColor" />
							</svg>
						</button>
						<button className="p-1.5 rounded hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-white/20" title="Notifications">
							<svg viewBox="0 0 24 24" className="size-5" fill="none" aria-hidden>
								<path d="M6 9a6 6 0 1 1 12 0v5l2 2H4l2-2Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
								<path d="M10 19a2 2 0 0 0 4 0" stroke="currentColor" strokeWidth="2" />
							</svg>
						</button>
						<button className="p-1.5 rounded hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-white/20" title="Profile">
			...
			{/* Workspace rail */}
			<aside className="hidden md:flex w-14 flex-col items-center justify-between border-r border-white/10 bg-black/80 py-3">
			...
			{/* Channels sidebar */}
			<aside className="hidden md:flex w-64 lg:w-72 flex-col border-r border-white/10 bg-neutral-950/90">
			...
			<main className="flex-1 flex min-w-0 flex-col">
				...
				<footer className="border-t border-white/10 p-2 sm:p-3">
					<form className="rounded-xl bg-white/5 focus-within:ring-2 focus-within:ring-white/20">
